...
public class CMakeSyntaxHighlighter extends SyntaxHighlighterBase {
  ...
  public static final TextAttributesKey CMAKE_VAR_REF = TextAttributesKey.createTextAttributesKey("CMAKE.CMAKE_VAR_REF",
          DefaultLanguageHighlighterColors.CONSTANT  );

  public static final TextAttributesKey CMAKE_VAR_DEF = createTextAttributesKey("CMAKE.CMAKE_VAR_DEF", Font.BOLD,
          DefaultLanguageHighlighterColors.CONSTANT  );

  public static final TextAttributesKey VAR_REF = TextAttributesKey.createTextAttributesKey("CMAKE.VAR_REF",
          DefaultLanguageHighlighterColors.INSTANCE_FIELD  );

  public static final TextAttributesKey VAR_DEF = createTextAttributesKey("CMAKE.VAR_DEF", Font.BOLD,
          DefaultLanguageHighlighterColors.INSTANCE_FIELD  );
